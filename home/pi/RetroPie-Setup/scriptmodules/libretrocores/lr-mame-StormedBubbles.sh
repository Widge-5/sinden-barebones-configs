...
rp_module_id="lr-mame-StormedBubbles"
...
function _get_params_lr-mame-StormedBubbles() {
...
function depends_lr-mame-StormedBubbles() {
...
function sources_lr-mame-StormedBubbles() {
    gitPullOrClone
}

function build_lr-mame-StormedBubbles() {
    rpSwap on 4096
    local params=($(_get_params_lr-mame-StormedBubbles) SUBTARGET=arcade)
    make clean
    make "${params[@]}"
    rpSwap off
...
function install_lr-mame-StormedBubbles() {
    md_ret_files=(
        'COPYING'
...
function configure_lr-mame-StormedBubbles() {
    local system
