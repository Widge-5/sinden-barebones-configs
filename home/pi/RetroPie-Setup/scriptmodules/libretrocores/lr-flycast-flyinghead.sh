...
rp_module_id="lr-flycast-flyinghead"
...
function depends_lr-flycast-flyinghead() {
...
function sources_lr-flycast-flyinghead() {
    gitPullOrClone
}

function build_lr-flycast-flyinghead() {
...
function install_lr-flycast-flyinghead() {
    md_ret_files=(
...
function configure_lr-flycast-flyinghead() {

    for system in arcade dreamcast; do
    mkRomDir "dreamcast"
