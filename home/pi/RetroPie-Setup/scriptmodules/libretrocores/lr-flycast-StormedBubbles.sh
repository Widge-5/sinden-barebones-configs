...
rp_module_id="lr-flycast-StormedBubbles"
...
rp_module_repo="git https://github.com/StormedBubbles/flycast.git revolver"
rp_module_section="opt"
rp_module_flags="!armv6"

function depends_lr-flycast-StormedBubbles() {
...
function install_lr-flycast-StormedBubbles() {
    md_ret_files=(
        'flycast_libretro.so'
        'LICENSE'
    )
...
function configure_lr-flycast-StormedBubbles() {
    local sys
